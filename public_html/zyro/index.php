<?php
	...
	$pages = array(
		'0'	=> array('id' => '1', 'alias' => 'Početna-stranica', 'file' => '1.php','controllers' => array()),
		'1'	=> array('id' => '2', 'alias' => 'Prijavi-se-na-konkurs', 'file' => '2.php','controllers' => array()),
		'2'	=> array('id' => '3', 'alias' => 'Lista-prijavljenih-studenata', 'file' => '3.php','controllers' => array())
	);
	$forms = array(
	...
	$base_url = '/';
	$user_domain = 'studentskicentar.000webhostapp.com';
	$show_comments = false;
	include dirname(__FILE__).'/functions.inc.php';
	$home_page = '1';
	list($page_id, $lang, $urlArgs, $route) = parse_uri();
	$user_key = "CRdYglB13SqXr1mGrBRMaVZgldSuO63Qhj2zXKypsgc2eA==";
	$user_hash = "78073787e0d408b9";
