 ...
 * @author DulleX
 */
public class UplatnicaZaZaduzenjeDTO {
    ...
    public UplatnicaZaZaduzenjeDTO(int idUplatnice, Date datumUplate, float iznosUplate, String username, String JMB, int brojSobe, short brojPaviljona, String skolskaGodina) {
    ...
    public UplatnicaZaZaduzenjeDTO() {
    }
